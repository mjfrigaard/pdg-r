...
meta() %>%
  ...
  meta_social(
    title = "Introduction to R Markdown",
    url = "https://github.com/mjfrigaard/pdg-r/r-markdown/",
    og_type = "website",
...
---
background-image: url(www/rmarkdown.png)
...
```{r rmarkdown, echo=FALSE, fig.align='center', out.width="10%", out.height="10%"}
knitr::include_graphics("www/rmarkdown.png")
```
...
```{r knitr, echo=FALSE, echo=FALSE, fig.align='center', out.width="10%", out.height="10%"}
# copy_slide_images("knitr.png")
knitr::include_graphics("www/knitr.png")
```
...
knitr::include_graphics("www/new-rmarkdown.png")
```
...
knitr::include_graphics("www/install-req-packages.png")
```
...
knitr::include_graphics("www/rmd-pckgs-jobs.png")
```
...
knitr::include_graphics("www/rmarkdown-defaults.png")
```
...
knitr::include_graphics("www/save-rmd-file.png")
```
...
knitr::include_graphics("www/knit-rmd-file.png")
```
...
knitr::include_graphics("www/rmarkdown-in-action.png")
```
...
---
background-image: url(www/how-rmd-works.png)
...
knitr::include_graphics("www/r-plus-md.png")
```
...
knitr::include_graphics("www/small-pressure.png")
```
...
knitr::include_graphics("www/params-plot.png")
```
...
---
background-image: url(www/markdown.png)
background-position: 93% 10%
background-size: 7%
class: left, top
...
knitr::include_graphics("www/delete-rmarkdown.png")
```
...
knitr::include_graphics("www/rmarkdown-exercise.png")
```
...
knitr::include_graphics("www/tabset-markdown.png")
```
...
knitr::include_graphics("www/tabset-1-render.png")
```
...
knitr::include_graphics("www/tabset-2-render.png")
```
...
knitr::include_graphics("www/knitr-opts-set.png")
```
...
knitr::include_graphics("www/code-chunk-name-args.png")
```
...
knitr::include_graphics("www/kable-code-chunk.png")
```
...
knitr::include_graphics("www/kable-chunk-rendered.png")
```
...
knitr::include_graphics("www/paged-code-chunk.png")
```
...
knitr::include_graphics("www/paged-chunk-render.png")
```
...
# knitr::include_graphics("www/paged-chunk-render.gif")
```
...
knitr::include_graphics("www/inline-code-rendered.png")
```
